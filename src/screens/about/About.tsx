    ...
    <div className="flex h-auto w-full items-center overflow-hidden text-primaryColor">
      <div className="w-full xl:w-2/3">
        ...
        <p className="pb-4 pl-10 text-lg">
          My name is <span className="text-lg text-themePrimaryColor">Shubham Raj Joshi</span> and I am an experienced{' '}
          <span className="text-lg text-themePrimaryColor">Software Engineer </span>
          with over 8 month of expertise in building web applications , software Application using{' '}
          <span className="text-lg text-themePrimaryColor">MERN STACK, PERN STACK , Spring Boot Java</span>{' '}
          technologies. Currently Working At UBA SOLUTION MONOTYPE
        </p>
        <p className="pb-4 pl-10 text-lg">
